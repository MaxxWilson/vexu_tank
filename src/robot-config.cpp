...
pros::Motor leftDriveMotorA = pros::Motor(11, driveGearset, true, encoder_units);
...
pros::Motor_Group leftDrive = pros::Motor_Group({leftDriveMotorA, leftDriveMotorD});
pros::Motor rightDriveMotorA = pros::Motor(13, driveGearset, false, encoder_units); // out
pros::Motor rightDriveMotorB = pros::Motor(1, driveGearset, false, encoder_units);	// out
...
pros::Motor_Group rightDrive = pros::Motor_Group({rightDriveMotorA, rightDriveMotorB});
